...
All four driver nodes start under the /scopio namespace and load their
parameters from config/params.yaml. Each node degrades gracefully if its
hardware is absent, so the graph comes up even on an incomplete rig.
"""
